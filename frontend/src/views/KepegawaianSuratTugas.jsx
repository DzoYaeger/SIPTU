...
const KepegawaianSuratTugas = () => {
    ...
    const pageSummary = useMemo(() => {
        ...
        const lengkap = data.filter((item) => item.status === "lengkap").length;
        const invalid = data.filter((item) => item.status === "invalid_tte").length;
        return {
                    ...
                    <Col xs={24} md={8}>
                        <Card size="small" style={{ borderRadius: 8 }}>
                            <Space>
                                ...
                                <Space direction="vertical" size={0}>
                                    <Text type="secondary">Total Surat Tugas</Text>
                    ...
                    <Col xs={24} md={8}>
                        <Card size="small" style={{ borderRadius: 8 }}>
                            <Space>
                                ...
                                <Space direction="vertical" size={0}>
                                    <Text type="secondary">Draft (halaman ini)</Text>
                                    <Title level={4} style={{ margin: 0 }}>
                                        {pageSummary.draft}
                                    </Title>
                                </Space>
                    ...
                    <Col xs={24} md={8}>
                        <Card size="small" style={{ borderRadius: 8 }}>
                            <Space>
                                ...
                                <Space direction="vertical" size={0}>
                                    <Text type="secondary">Lengkap (halaman ini)</Text>
                                    <Title level={4} style={{ margin: 0 }}>
                                        {pageSummary.lengkap}
                                    </Title>
                                </Space>
                    ...
                    <Col xs={24} md={6}>
                        <Card size="small" style={{ borderRadius: 8 }}>
                            <Space>
                                ...
                                <Space direction="vertical" size={0}>
                                    <Text type="secondary">Invalid TTE (halaman ini)</Text>
                                    <Title level={4} style={{ margin: 0 }}>
                                        {pageSummary.invalid}
                                    </Title>
                                </Space>
                ...
                >
                    <Row gutter={[10, 10]} align="middle">
                        <Col xs={24} md={12} lg={10}>
                            <Input
                                placeholder="Cari pegawai, nomor ST, MAK, deskripsi..."
                        ...
                        <Col xs={24} md={8} lg={7}>
                            <Segmented
                                ...
                                options={[
                                    ...
                                    { label: "Invalid TTE", value: "invalid_tte" },
                        ...
                        <Col xs={24} lg={3}>
                            <Text type="secondary" style={{ fontSize: 12 }}>
                                Menampilkan {pageSummary.showing} data
                            </Text>
                        </Col>
                    </Row>
                </Card>
