            ...
            {!collapsed && (
              <div className="rhpk-sidebar-brand">
                <div className="rhpk-sidebar-brand__icon">
                  <img src={rispegPengumumanIcon} alt="RHPK" style={{ width: 34, height: 34, objectFit: "contain" }} />
                </div>
                <div>
                  <h1 className="rhpk-sidebar-brand__title">RHPK</h1>
                  <div className="rhpk-sidebar-brand__subtitle">BPOM Palopo</div>
                </div>
              </div>
            )}
            <button className="rhpk-toggle-btn" onClick={() => setCollapsed(!collapsed)}>
              {collapsed ? <MenuUnfoldOutlined /> : <MenuFoldOutlined />}
            </button>
          </div>
        </div>

        <nav className="rhpk-sidebar-nav">
          <div
      ...
      >
        ...
        <div className="rhpk-toolbar">
          <div className="rhpk-toolbar__left">
            <div>
              <Title level={4} className="rhpk-toolbar__title">{toolbarTitle}</Title>
              <p className="rhpk-toolbar__desc">{toolbarDesc}</p>
            </div>
            ...
            <Input
              ...
              allowClear
            />
            <Select value={selectedYear} onChange={setSelectedYear} style={{ width: 110 }} size="small">
          ...
          <Space>
            ...
            {isAdmin && activeNav === "capaian-output" && (
              <Button type="primary" icon={<PlusOutlined />} size="small" onClick={() => handleOpenTargetModal()}
                style={{ background: "#0f5b99", borderColor: "#0f5b99", fontWeight: 600 }}>
                Tambah RO
              </Button>
            )}
            {isAdmin && activeNav === "penjelasan-capaian" && (
              <Button type="primary" icon={<PlusOutlined />} size="small" onClick={() => handleOpenIndicatorModal()}
                style={{ background: "#0f5b99", borderColor: "#0f5b99", fontWeight: 600 }}>
                Tambah Indikator
              </Button>
            )}
