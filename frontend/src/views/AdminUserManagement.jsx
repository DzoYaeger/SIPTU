...
const MODULE_GROUPS = [
  {
    key: "kepegawaian",
    title: "Kepegawaian",
    description: "Manajemen data pegawai, kalender, dan surat tugas.",
    accent: "kepegawaian",
    slugs: ["kepegawaian", "kepegawaian-data-pegawai", "kepegawaian-kgb", "kepegawaian-kalender", "kepegawaian-surat-tugas"],
  },
  {
    key: "rispeg",
    title: "RISPEG",
    description: "Sistem informasi pegawai untuk monitoring dan input data.",
    accent: "rispeg",
    slugs: ["rispeg", "rispeg-ruh", "rispeg-dashboard", "rispeg-izin-keluar"],
  },
  {
    key: "kearsipan",
    title: "Kearsipan",
    description: "Pengelolaan peminjaman arsip dan manajemen unit pengolah.",
    accent: "kearsipan",
    slugs: [
      "kearsipan",
  ...
  },
  {
    ...
    description:
      "Mengatur akses untuk pengelolaan data aset, persediaan, pemeliharaan, dan peminjaman BMN.",
    accent: "bmn",
    slugs: [
      "bmn",
      "bmn-data-aset-tetap",
  ...
  {
    key: "pengadaan-pdtt",
    title: "Pengadaan PDTT",
    description: "Kolaborasi usulan penambah daya tahan tubuh.",
    accent: "pengadaan",
    slugs: ["pengadaan-pdtt"],
  },
  {
    key: "it-helpdesk",
  ...
  },
  {
    key: "layanan",
    title: "Layanan",
    description: "Layanan mandiri dan riwayat pengajuan pegawai.",
    accent: "layanan",
    slugs: ["layanan-mandiri", "riwayat-layanan"],
  },
  {
    key: "siamparan",
    title: "SIAMPARAN V2",
  ...
  },
  {
    key: "antrian",
    title: "Manajemen UPP",
    description: "Kontrol antrian TV dan manajemen loket.",
    accent: "layanan",
  ...
  },
  {
    ...
    description: "Dashboard monitoring dan rekapan pengajuan untuk operator.",
    accent: "operator",
    slugs: ["operator-dashboard"],
    autoAssign: ["operator"], // Auto-assign untuk user dengan role operator
  },
];
