...
import { Card, Input, Button, Typography, message, Spin, Result, Divider, Space, Tag } from "antd";
...
const SignProtokolPage = ({ type = "ketua" }) => {
  ...
  const handleSign = async () => {
    ...
    if (!totpCode && !user?.mfa_session_active) {
          ...
          <Space direction="vertical" size="large" style={{ width: "100%" }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 }}>
                <Text style={{ fontSize: 12, fontWeight: 600 }}>Kode MFA / Recovery:</Text>
