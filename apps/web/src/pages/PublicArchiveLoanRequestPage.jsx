...
import { ArrowLeftOutlined, SafetyCertificateOutlined, FileTextOutlined, UserOutlined, InfoCircleOutlined, FormOutlined, LockOutlined } from "@ant-design/icons";
          ...
          >
            ...
            <Form form={form} layout="vertical">
              ...
              <Form.Item
                ...
                rules={[{ required: !user?.mfa_session_active, message: "Kode autentikasi MFA wajib diisi." }]}
              >
                <Input 
