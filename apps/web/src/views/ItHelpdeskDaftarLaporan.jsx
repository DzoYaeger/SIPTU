...
const ItHelpdeskDaftarLaporan = () => {
  const { user, apiFetch, token, markMfaSessionActive } = useAuth();
        ...
        >
          <div style={{ padding: "16px 0 0 0" }}>
            ...
            >
              ...
              <Form.Item
                ...
                label={
                  <Space style={{ justifyContent: 'space-between', width: '100%' }}>
                    <Text strong style={{ fontSize: 13 }}>Kode Autentikasi MFA (6 Digit / Recovery Code)</Text>
              ...
              >
                <Input placeholder={user?.mfa_session_active ? "Opsional (Sesi MFA Aktif)" : "Contoh: 123456 atau XXXX-XXXX (jika akun mengaktifkan MFA)"} style={{ borderRadius: 8, height: 38, fontWeight: 700, letterSpacing: '1px' }} />
              </Form.Item>
            </Form>
          </div>
        </Modal>
