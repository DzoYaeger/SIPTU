...
const BmnPeminjamanAsetForm = () => {
  const { apiFetch, user, markMfaSessionActive } = useAuth();
      ...
      <Card className="form-card">
        <Form form={form} layout="vertical" requiredMark={false} onFinish={handleSubmit}>
          ...
          <Form.Item
            ...
            rules={[{ required: !user?.mfa_session_active, message: 'Kode MFA wajib diisi untuk verifikasi TTE.' }]}
          >
            <Input placeholder={user?.mfa_session_active ? 'Opsional (Sesi MFA Aktif)' : 'Contoh: 123456 atau XXXX-XXXX'} style={{ fontWeight: 700, letterSpacing: '1px' }} />
          </Form.Item>
