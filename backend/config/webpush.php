...
return [
     ...
     */
    'vapid' => [
        'subject' => env('VAPID_SUBJECT', 'mailto:admin@bpompalopo.com'),
        'public_key' => env('VAPID_PUBLIC_KEY', 'BFrbpJpn1aY1RDiOuVGGRCB1McBMdni3V94M7nE6TAYkYSArLvedwPJjM_mrtynk6JwAnm9cCvY1peB1areS-6w'),
        'private_key' => env('VAPID_PRIVATE_KEY', 'tg1YQzZSvmpKf51SYN2wTeSoYVpB0b_BImVcScFh9rA'),
